...
function Profil() {
  ...
  const [user, setUser] = useState(JSON.parse(localStorage.getItem("user")) || { name: "Étudiant", email: "" })
  ...
  const anneeInscription = user.created_at ? new Date(user.created_at).getFullYear() : new Date().getFullYear()
